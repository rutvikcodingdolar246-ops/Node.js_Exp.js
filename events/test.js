...
emitter.emit("user-login", "rutvik");
emitter.emit("user-purchase", "rutvik", "Laptop");
emitter.emit("profile-update", "rutvik", "email");
emitter.emit("user-logout", "rutvik");

emitter.emit("summary");   // ✅ Fixed