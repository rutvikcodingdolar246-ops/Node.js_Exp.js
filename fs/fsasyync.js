...
//* fs.readFile(): Reads the contents of a file asynchronously and returns the data as a
// buffer or string.
// //! syntax: fs.readFile(path, options, callback);

// //? path: File path to read from.
// //? options: Optional. An object or string specifying the encoding ('utf8') or flag ('r'
// for reading).
