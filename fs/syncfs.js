...
//fs.writeFileSync(): Writes data to a file. If the file does not exist, it will be
// created. If the file exists, it overwrites the content.
...
// const writeFile = fs.writeFileSync(filePath, "This is the initial Data, updata","utf-8")
...
// //* fs.appendFileSync(): Appends data to a file. If the file does not exist, it
// creates the file.
...
// const fileDetete = fs.unlinkSync(filePath)

// console.log(fileDetete);
